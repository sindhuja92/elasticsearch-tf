...
runcmd:
 ...
 - aws s3 cp s3://${certs_bucket_name}/bootstrap.txt .
 - read -r credential < bootstrap.txt
 - echo "$credential" | /usr/share/elasticsearch/bin/elasticsearch-keystore add "bootstrap.password"
